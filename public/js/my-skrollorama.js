...
//        controller.addTween('#scale-it',TweenMax.fromTo($('#scale-it'), 25, {css:{opacity:0, fontSize:'20px'}, immediateRender:true, ease:Quad.easeInOut}, {css:{opacity:1, fontSize:'240px'}, ease:Quad.easeInOut}));
        ...
        /* SLIDE 1*/
        var logoTween = TweenMax.fromTo($('#home-logo'), .25, {css:{opacity:1, width:'20px'}, immediateRender:true, ease:Quad.easeOutBack}, {css:{opacity: 0, width:'640px'}, ease:Quad.easeOutQuad});
        controller.addTween('#home-logo',
            logoTween);

        /* SLIDE 2 */
        controller.addTween('#bishop',
            TweenMax.fromTo($('#bishop'), .25, {css:{left:'-120px'}, immediateRender:false, ease:Quad.easeInOut}, {css:{left:'120px'}, ease:Quad.easeInOut}));
